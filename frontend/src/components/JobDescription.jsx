...
import { formatSalary, formatSalaryDetailed } from '@/utils/salaryFormatter';
        ...
        <div className='min-h-screen bg-white dark:bg-gray-900'>
            ...
            <div className='max-w-7xl mx-auto my-10 px-4'>
                ...
                <div className='my-4'>
                    ...
                    <h1 className='font-bold my-1 text-gray-900 dark:text-white'>Salary: <span className='pl-4 font-normal text-gray-800 dark:text-gray-300'>{formatSalaryDetailed(singleJob?.salary)}</span></h1>
